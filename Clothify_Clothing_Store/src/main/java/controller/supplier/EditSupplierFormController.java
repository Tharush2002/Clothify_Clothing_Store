...
public class EditSupplierFormController implements Initializable {
    ...
    @FXML
    private TextField txtSetSetSupplierCompany;

    @FXML
    private TextField txtSetSupplierEmail;

    @FXML
    private TextField txtSetSupplierName;
    ...
    void btnSaveSupplierOnAction(ActionEvent event) {
        try{
            ...
            if(!name.isEmpty() && isValidEmail(email) && !company.isEmpty()){
                ...
                employeeDashboardFormController.loadSuppliersTable(supplierService.getAll());
    ...
    private void setInitialState() {
        lblSupplierId.setText(selectedSupplierToEdit.getSupplierId());
